...
var distanceShowing:Bool = false
var distancesInMeter: [Int] = [3200, 8000, 16000, 32000 ]

var sortByText: [String] = ["Best match", "Distance", "Highest rated"]
...
var isCategorySelected: [String:Bool] = [:]
